...
Then, I moved to Leuven to pursue my Master degree in statistics at the Catholic University of Leuven, a 600-years old institution which was home to many renaissance humanists such as Mercator, after which the map projection is named, and 
...
I am currently building AI models of the ocean, which are trained on Princeton's traditional biogeochemical models. These AI models can be run much faster than the traditional biogeochemical models they are trained on and on much more inexpansive hardware, think one $5000  GPU for the AI ocean model instead of a $1,000,000 high-performance computing cluster for the traditiona ocean model. This holds much promise for my friends at Princeton, because it will help them understand how their traditional models work much faster and for much cheaper, but most importantly, this will address a _fundamental resource gap_ between top tier institutions such as MIT, IPSL, Princeton, the Max Planck Institute, Tsinghua etc... and middle tier institutions which do not have the resources and people to run traditional ocean models.
